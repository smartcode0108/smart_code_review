...
# Ollama API details
OLLAMA_API_URL = "https://api.ollama.ai/generate"  # Replace with the actual API URL
OLLAMA_API_KEY = os.getenv("OLLAMA_API_KEY")  # Store your API key in GitHub Secrets
